...
from EfiPy.MdePkg.Protocol.GraphicsOutput import gEfiGraphicsOutputProtocolGuid, EFI_GRAPHICS_OUTPUT_PROTOCOL, EFI_GRAPHICS_OUTPUT_MODE_INFORMATION, EFI_GRAPHICS_OUTPUT_BLT_PIXEL
from EfiPy.MdePkg.Protocol.GraphicsOutput import PixelRedGreenBlueReserved8BitPerColor, PixelBlueGreenRedReserved8BitPerColor, PixelBitMask, PixelBltOnly, EfiBltVideoFill
...
from EfiPy.MdePkg.Protocol.HiiFont  import gEfiHiiFontProtocolGuid, EFI_HII_FONT_PROTOCOL, EFI_FONT_DISPLAY_INFO, EFI_HII_ROW_INFO
from EfiPy.MdePkg.Protocol          import HiiFont as ft
...
def FontTest ():
  ...
  Font.PrintXY (u"EEEEEEEEEEEEE      fffffffff                 PPPPPPPPPPP                  ", 100, 200)
  Font.NextLine ()
  Font.PrintXY (u"EEEEEEEEEEEEE     fffffffffff       iii      PPPPPPPPPPPP                 ")
  Font.NextLine ()
  Font.SetColor (0xFF, 0xFF, 0)
  Font.PrintXY (u" EEE      EEE     fff      fff      iii       PPP      PPP                ")
  Font.NextLine ()
  Font.PrintXY (u" EEE   EEE        fff                         PPP      PPP   yyy       yyy")
  Font.NextLine ()
  Font.SetColor (0, 0xFF, 0)
  Font.PrintXY (u" EEEEEEEEE     fffffffffff        iiiii       PPPPPPPPPPP    yyy       yyy")
  Font.NextLine ()
  Font.PrintXY (u" EEEEEEEEE     fffffffffff        iiiii       PPPPPPPP       yyy       yyy")
  Font.NextLine ()
  Font.SetColor (0, 0xFF, 0xFF)
  Font.PrintXY (u" EEE   EEE        fff               iii       PPP            yyy       yyy")
  Font.NextLine ()
  Font.PrintXY (u" EEE      EEE     fff               iii       PPP            yyy       yyy")
  Font.NextLine ()
  Font.SetColor (0, 0, 0xFF)
  Font.PrintXY (u"EEEEEEEEEEEEE  fffffffffff       iiiiiiiii   PPPPPPP          yyyyyyyyyyyy")
  Font.NextLine ()
  Font.PrintXY (u"EEEEEEEEEEEEE  fffffffffff       iiiiiiiii   PPPPPPP          yyyyyyyyyyyy")
  Font.NextLine ()
  ...
  Font.PrintXY (u"                                                                      yyyy")
  Font.NextLine ()
  Font.PrintXY (u"                                                             yyyyyyyyyyyy ")
  Font.SetColor (0x80, 0x80, 0x80)
  Font.NextLine ()
  Font.PrintXY (u"                                                            yyyyyyyyyyy  ")
...
def RulerTest (Note = False):
  ...
  if Note == True:
    fnt.PrintXY (u"Resolution X Axis: %d" % Gfx.Info.HorizontalResolution, 50, 50)
    fnt.PrintXY (u"Resolution Y Axis: %d" % Gfx.Info.VerticalResolution, 50, 70)

  fnt.PrintXY (u"0", 15, 15)
  ...
  for x in range (100, Gfx.Info.HorizontalResolution, 100):
    ...
    Gfx.Rect (x, 0, 1, h)
    fnt.PrintXY (u"%d" % x, x, h + 2)

  x = Gfx.Info.HorizontalResolution - 1
  Gfx.Rect (x, 0, 1, h + fnt.LineHeight * 2)
  fnt.PrintXY (u"%d" % x, x - fnt.LineWidth, h + fnt.LineHeight * 2 + 2)
  ...
  for y in range (100, Gfx.Info.VerticalResolution, 100):
    ...
    Gfx.Rect (0, y, w, 1)
    fnt.PrintXY (u"%d" % y, w + 2, y - 19)
    len = fnt.PointerX
  
  Gfx.Rect (0, Gfx.Info.VerticalResolution - 1, w + len, 1)
  fnt.PrintXY (u"%d" % (Gfx.Info.VerticalResolution - 1), w + len + 2, Gfx.Info.VerticalResolution - 20)
...
if __name__ == '__main__':
  ...
  Gfx.clear ()
  TestHint (fnt, u"Font Demo, Press any key to begin...")
  Gfx.clear ()
  FontTest ()
  TestHint ()

  Gfx.clear ()
  TestHint (fnt, u"Ruler Demo, Press any key to begin...")
  Gfx.clear ()
  RulerTest (True)
  TestHint ()

  Gfx.clear ()
  TestHint (fnt, u"Grid Demo, Press any key to begin...")
  Gfx.clear ()
  GridTest (Gfx)

  Gfx.clear ()
  TestHint (fnt, u"Demo Complete")
