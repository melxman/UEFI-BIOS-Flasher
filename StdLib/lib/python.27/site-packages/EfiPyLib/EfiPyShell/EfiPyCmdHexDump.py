...
#
# EfiPyCmdHexDump.py is free software: you can redistribute it and/or modify
...
class EFIPY_CMD_HEXDUMP (EfiPyCmdFileOp.EFIPY_CMD_FILE_OP):
  '''[INIT] Full screen hex dump for files, block devices, or memory.'''
  ...
  def Run (self):
    ...
    while True:
      ...
      EfiPyHexDump (self.StdOut, 2, Address + TotalSize, DumpBuff, True)
...
if __name__ == '__main__':
  ...
  EfiPyCmdObj = EFIPY_CMD_HEXDUMP (CmdSet)
