...
class SectionDoubleP:
    ...
    def __add_header_space(self):
        ...
        # BUG self.pe.set_dword_at_offset(SizeOfHeaders_offset, SizeOfHeaders + FileAlignment)
        self.pe.set_dword_at_offset(SizeOfHeaders_offset, SizeOfHeaders + FileAlignment * 2)
        ...
        for section in self.pe.sections:
            if 0 and section.PointerToRawData != 0:
    ...
    def push_back(self, Name=".NewSec", VirtualSize=0x00000000, VirtualAddress=0x00000000, 
        ...
        if self.pe.FILE_HEADER.NumberOfSections == len(self.pe.sections):
            ...
            section_table_offset = (self.pe.DOS_HEADER.e_lfanew + 4 + 
                self.pe.FILE_HEADER.sizeof() + self.pe.FILE_HEADER.SizeOfOptionalHeader)
            fHeaderSize = self.pe.FILE_HEADER.sizeof()
            fOptionSize = self.pe.FILE_HEADER.SizeOfOptionalHeader
...
iFileName = "Py2Efi.efi"
oFileName = "o" + iFileName
def main(argv):
    pe =  pefile.PE(iFileName)
