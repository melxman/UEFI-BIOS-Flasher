...
# py2efi specific portion - this should be removed before inclusion in the
# Python distribution
...
class ModuleFinder(Base):
    ...
    def create_xref(self):
        ...
        # ofi = open(htmlfile, "w")
        # os.close(fd)
        # print >> ofi, "<html><title>py2efi cross reference for %s</title><body>" % sys.argv[0]

        # print >> ofi, "<h1>py2efi cross reference for %s</h1>" % sys.argv[0]
